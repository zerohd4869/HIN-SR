...
def main():
    ...
    parser.add_argument("--wf_data_dir", default=None, type=str, required=True,
                        help="The output data dir. Should contain the .tsv files (or other data files) for the task.")
